...
public class GetQueryHandler : BaseQueryHandler<GetQuery, IEnumerable<Car>>
{
    public GetQueryHandler(IHttpMessageBuilder httpMessageBuilder, IOptions<ApiOptions> apiOptions) 
